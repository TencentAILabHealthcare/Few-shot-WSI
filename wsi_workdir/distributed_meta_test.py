...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_task', type=int, default=300, help='one of [near, mixture, out]')
    parser.add_argument('--num_shots', type=int, default=5, help='one of [near, mixture, out]')
    parser.add_argument('--num_aug_shots', type=int, default=100, help='one of [near, mixture, out]')
    parser.add_argument('--mode', type=str, default='linear')
    parser.add_argument('--clf', type=str, default='Ridge')
    parser.add_argument('--aug_times', type=int, default=0, help='one of [near, mixture, out]')
    parser.add_argument('--num_prototypes', type=int, default=16, help='one of [near, mixture, out]')
